...
1. Add a screenshot of the output of the unit tests. If any failed, add a screenshot of the error message and a screenshot after you have fixed the errors:
   ...
   ![Failed unit tests](images/failed_unit_tests.png)

   ![Passed unit tests](images/passed_unit_tests.png)
...
1. Add a screenshot of the output of the unit tests. If any failed, add a screenshot of the error message and a screenshot after you have fixed the errors:
   ...
   ![Failed unit tests](images/failed_unit_tests_display.png)

   ![Passed unit tests](images/passed_unit_tests_display.png)
...
> `CarPark`, as that is the class that `register()` belongs to 
...
![Added methods to the car park class](images/more-methods-to-car-park.png)
